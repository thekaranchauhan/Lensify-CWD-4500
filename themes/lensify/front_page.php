		...
		<?php if( has_post_thumbnail() ) : ?>
			<section class="lensify-front-page-banner">
				...
				if ( $lensify_description || is_customize_preview() ) :
					?>
					<p class="site-description"><?php echo $lensify_description; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></p>
				<?php endif; ?>
				</div>
			</section>
		<?php
...
</div><!-- #lensify-front-page-wrapper (starts in header.php)-->
<?php
get_footer();